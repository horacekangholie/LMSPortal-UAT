...
Partial Class Views_DIGI_Singapore
    Inherits LMSPortalBaseCode

    Dim PageTitle As String = "DIGI Singapore"
    Dim sqlStr As String = "SELECT ROW_NUMBER() OVER(ORDER BY Name ASC) AS No, * " &
                           "FROM R_Customer_List " &
                           "WHERE [Group Name] = 'DIGI Singapore' " &
                           "  AND [Customer ID] IN (SELECT Customer_ID FROM DMC_Headquarter) "

    Dim reportColName As String() = {"No", "Name", "Type", "Country", "Group Name"}
    Dim reportColSize As Integer() = {0, 300, 100, 100, 100}
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Attributes.Add("OnClick", String.Format("window.location='/Views/Subscription_Details.aspx?Customer_ID={0}&Group={1}'", drv("Customer ID"), "5"))
        End If
    End Sub
