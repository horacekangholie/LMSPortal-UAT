<%@ Page Title="LMSPortal - DMC Revenue By Account Type (USD)" 
    Language="VB" 
    MasterPageFile="~/MasterPages/Frontend.master" 
    AutoEventWireup="false" 
    CodeFile="DMC_Account_Revenue_By_Account_Type_Base_USD.aspx.vb" 
    MaintainScrollPositionOnPostback="true"
    EnableEventValidation="false"
    Inherits="Views_DMC_Account_Revenue_By_Account_Type_Base_USD" %>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-8">
                            <div class="table-responsive mb-4">
                                <asp:GridView ID="GridView1" runat="server" AllowSorting="false" CssClass="table table-bordered">
                                    <Columns>
                                        <asp:BoundField DataField="Device_Type" HeaderText="Account Type" SortExpression="Device_Type" ItemStyle-Width="12%" ItemStyle-Wrap="true" />
                                        <asp:BoundField DataField="Country" HeaderText="Country" SortExpression="Country" ItemStyle-Width="8%" ItemStyle-Wrap="true" />
                                        <asp:BoundField DataField="Headquarter_ID" HeaderText="Headquarter ID" SortExpression="Headquarter_ID" ItemStyle-Width="10%" ItemStyle-Wrap="true" />
                                        <asp:BoundField DataField="Headquarter_Name" HeaderText="Headquarter Name" SortExpression="Headquarter_Name" ItemStyle-Width="30%" ItemStyle-Wrap="true" />
                                        <asp:BoundField DataField="Owned_Store" HeaderText="Owned Store" SortExpression="Owned_Store" DataFormatString="{0:#}" ItemStyle-Width="10%" ItemStyle-Wrap="true" />
                                        <asp:BoundField DataField="Currency" HeaderText="Currency" SortExpression="Currency" ItemStyle-Width="8%" ItemStyle-Wrap="true" />
                                        <asp:BoundField DataField="Total_Amount_Per_Month" HeaderText="Total Amount (Monthly)" HeaderStyle-CssClass="header-break" SortExpression="Total_Amount_Per_Month" ItemStyle-Width="15%" ItemStyle-Wrap="true" />
                                        <asp:BoundField DataField="Average" HeaderText="Average" SortExpression="Average" DataFormatString="{0:#,##0.00}" ItemStyle-Width="7%" ItemStyle-Wrap="true" />
                                    </Columns>
                                </asp:GridView>
                            </div>
                        </div>
