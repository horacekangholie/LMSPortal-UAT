<%@ Page Title="LMSPortal - Database Table Monitoring" 
    Language="VB" 
    MasterPageFile="~/MasterPages/Frontend.master" 
    AutoEventWireup="false" 
    CodeFile="Database_Table_Repack_Monitoring.aspx.vb" 
    Inherits="Views_Database_Table_Repack_Monitoring" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
    ...
    <!-- Content -->
    <div ID="DatabaseTableBloatednessReport" runat="server" class="selectedTab">
        <ul class='nav nav-tabs' id="myTab" role="tablist">
            <li id="tab_link1" runat="server" visible="true" class="nav-item" role="presentation"><a id="link1" class="nav-link active" data-toggle="tab" href="#BloatednessByRatio" aria-selected="true" role="tab"  style="font-size: 15px; width: 150px; text-align: center">By Ratio</a></li>
            <li id="tab_link2" runat="server" visible="true" class="nav-item" role="presentation"><a id="link2" class="nav-link" data-toggle="tab" href="#BloatednessByPercentage" aria-selected="false" tabindex="-1" role="tab" style="font-size: 15px; width: 150px; text-align: center">By Percentage</a></li>
        </ul>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane active" id="BloatednessByRatio" role="tabpanel">
                <!-- DMC Account pg_repack monitoring By ratio Gridview -->
                <asp:GridView ID="GridView1" runat="server"></asp:GridView>
            </div>
            <div class="tab-pane" id="BloatednessByPercentage" role="tabpanel">
                <!-- DMC Account pg_repack monitoring By Percentage Gridview -->
