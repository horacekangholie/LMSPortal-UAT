...
Partial Class Views_Overseas_Subsidiaries
    Inherits LMSPortalBaseCode

    Dim PageTitle As String = "Overseas Subsidiaries"
    Dim sqlStr As String = "SELECT ROW_NUMBER() OVER(ORDER BY Name ASC) AS No, * " &
                           "FROM R_Customer_List " &
                           "WHERE [Group Name] = 'Overseas Subsidiaries' " &
                           "  AND [Customer ID] IN (SELECT Customer_ID FROM DMC_Headquarter) "

    Dim reportColName As String() = {"No", "Name", "Type", "Country", "Code", "Group Name"}
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Attributes.Add("OnClick", String.Format("window.location='/Views/Subscription_Details.aspx?Customer_ID={0}&Group={1}'", drv("Customer ID"), "3"))
        End If
    End Sub
