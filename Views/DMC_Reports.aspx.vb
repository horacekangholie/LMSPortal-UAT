...
Partial Class Views_DMC_Reports
    Inherits LMSPortalBaseCode

    Dim PageTitle As String = "DMC Related Reports"
    Dim sqlStr As String = "SELECT ROW_NUMBER() OVER(ORDER BY [Report_Name] ASC) AS No, * FROM DMC_Account_Reports_List "
