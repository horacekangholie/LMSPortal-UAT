<%@ Page Title="LMSPortal - DMC Revenue By Country" 
    Language="VB" 
    MasterPageFile="~/MasterPages/Frontend.master" 
    AutoEventWireup="false" 
    CodeFile="DMC_Account_Revenue_By_Country.aspx.vb" 
    MaintainScrollPositionOnPostback="true"
    EnableEventValidation="false"
    Inherits="Views_DMC_Account_Revenue_By_Country" %>
            ...
            <div class="tab-pane" id="RevenueOverview" role="tabpanel">
                <div class="tab-box">
                    <div class="alert alert-info">
                        <div class="dropdownlist-guided-text"><b>Note: </b>View report by country</div>
                        <asp:DropDownList ID="DDL_Country" runat="server" CssClass="form-control w-25" AutoPostBack="true">
                        </asp:DropDownList>
                    </div>
