<%@ Page Title="LMSPortal - Customer Info" 
    Language="VB" 
    MasterPageFile="~/MasterPages/Frontend.master" 
    AutoEventWireup="false" 
    CodeFile="Customer_Form.aspx.vb" 
    Inherits="Form_Customer_Form" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
                    ...
                    <table border="0" style="width: 100%">
                        <tr style="vertical-align: top">
                            <td style="width: 50%; padding: 0px 10px 10px 0px">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredField_E_Name" runat="server" 
                            ...
                            <td style="width: 20%; padding: 0px 10px 10px 0px">
                                <label>Code</label>
                                <asp:TextBox ID="TB_Code" Text='<%# Eval("Distributor_Code") %>' runat="server" CssClass="form-control" />
                            </td>
                        ...
                        <tr style="vertical-align: top">
                            <td style="width: 50%; padding: 0px 10px 10px 0px" rowspan="2">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredField_E_Address" runat="server" 
                                    ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                    Display="Dynamic"
                                    SetFocusOnError="True"
                            ...
                            <td style="width: 30%; padding: 0px 10px 10px 0px">
                                ...
                                <asp:DropDownList ID="DDL_Group_ID" runat="server" CssClass="form-control"
                        ...
                        <tr style="vertical-align: top">
                            <td style="width: 50%; padding: 0px 10px 10px 0px">
                                ...
                                <asp:TextBox ID="TB_Contact_Person" Text='<%# Eval("Contact_Person") %>' runat="server" CssClass="form-control" />
                            </td>
                            <td style="width: 20%; padding: 0px 10px 10px 0px">
                                <label>Phone</label>
                    ...
                    <table border="0" style="width: 100%">
                        <tr style="vertical-align: top">
                            <td style="width: 50%; padding: 0px 10px 10px 0px">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredField_I_Name" runat="server" 
                                    ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                    Display="Dynamic"
                                    SetFocusOnError="True"
                                    ControlToValidate="TB_Name">
                            ...
                            <td style="width: 30%; padding: 0px 10px 10px 0px">
                                <label>Country</label>
                                <asp:Label ID="LB_Country" runat="server" Visible="false" />
                                <asp:DropDownList ID="DDL_Country" runat="server" CssClass="form-control"
                                    DataSourceID="Country_SqlDataSource"
                                    DataTextField="Country"
                                    DataValueField="Country"
                        ...
                        <tr style="vertical-align: top">
                            <td style="width: 50%; padding: 0px 10px 10px 0px" rowspan="2">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredField_I_Address" runat="server" 
                                    ErrorMessage="This field cannot be blank" CssClass="invalid-feedback"
                                    Display="Dynamic"
                                    SetFocusOnError="True"
                                    ControlToValidate="TB_Address">
                            ...
                            <td style="width: 30%; padding: 0px 10px 10px 0px">
                                <label>Group</label>
                                <asp:Label ID="LB_Group_ID" runat="server" Visible="false" />
                                <asp:DropDownList ID="DDL_Group_ID" runat="server" CssClass="form-control"
                                    DataSourceID="Group_SqlDataSource"
                                    DataTextField="Name"
                                    DataValueField="Group_ID"
                        ...
                        <tr style="vertical-align: bottom">
                            <td style="width: 50%; padding: 0px 10px 10px 0px" colspan="2">
                                <label id="lbl_By_Distributor" runat="server">By Distributor</label>
                                <asp:Label ID="LB_By_Distributor" runat="server" Visible="false" />
                                <asp:DropDownList ID="DDL_By_Distributor" runat="server" CssClass="form-control"
                                    DataSourceID="By_Distributor_SqlDataSource"
                                    DataTextField="Name"
                                    DataValueField="Customer_ID"
    ...
    <!-- Control Button -->
    <asp:LinkButton ID="BT_Create" Text="Create" CommandName="Create" runat="server" CssClass="btn btn-default"></asp:LinkButton>
