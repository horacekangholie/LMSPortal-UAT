<%@ Page Title="LMSPortal - CZL Account" 
    Language="VB" 
    MasterPageFile="~/MasterPages/Frontend.master" 
    AutoEventWireup="false" 
    CodeFile="CZL_Account.aspx.vb" 
    Inherits="Form_CZL_Account" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
    ...
    <div class="form-group form-inline" style="float: right">
        <asp:TextBox ID="TB_Search" runat="server" CssClass="form-control" Width="500" placeholder="Client ID, Account Name, By Distributor, Country, Gen Version" TextMode="Search"></asp:TextBox>
        <asp:Button ID="BT_Search" runat="server" CssClass="form-control btn btn-outline btn-info" Text="Search" />
    </div>

    <div class="form-group form-inline">
        <asp:LinkButton ID="BT_Create" runat="server" CssClass="btn btn-default" Text="New Account"></asp:LinkButton>
    </div>
