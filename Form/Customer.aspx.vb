...
Partial Class Form_Customer
    ...
    Dim PageTitle As String = "Customer Master"
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            EditLinkButton.PostBackUrl = "~/Form/Customer_Form.aspx?Customer_ID=" & drv("Customer ID")
        End If
    End Sub
    ...
    Protected Sub BT_Create_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BT_Create.Click
        Response.Redirect(String.Format("/Form/Customer_Form.aspx?Customer_ID={0}", ""))
    End Sub
