...
Partial Class Services_Maintenance_Reports
    Inherits LMSPortalBaseCode

    Dim PageTitle As String = "Maintenance Service Reports"
    Dim sqlStr As String = "SELECT ROW_NUMBER() OVER(ORDER BY [Report_Name] ASC) AS No, * FROM Maintenance_Services_Reports_List "
    Dim reportCol As String() = {"No", "Report_Name"}
    Dim reportColName As String() = {"No", "Report Name"}
    Dim reportColSize As Integer() = {0, 100}
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Attributes.Add("OnClick", String.Format("window.location='{0}?id={1}'", drv("Path"), drv("ID")))
        End If
    End Sub
