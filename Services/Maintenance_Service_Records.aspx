<%@ Page Title="Maintenance Service Records" 
    Language="VB" 
    MasterPageFile="~/MasterPages/Frontend.master" 
    AutoEventWireup="false" 
    CodeFile="Maintenance_Service_Records.aspx.vb" 
    Inherits="Services_Maintenance_Service_Records" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
    ...
    <div class="form-group form-inline">
        <asp:LinkButton ID="BT_Create" runat="server" CssClass="btn btn-default" Text="New Customer"></asp:LinkButton>
    </div>
