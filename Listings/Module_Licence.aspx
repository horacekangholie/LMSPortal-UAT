                ...
                <table border="0" class="modalPopupTable" style="width: 100%">
                    <tr style="vertical-align: top">
                        ...
                        <td style="width: 400px; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RegularExpressionValidator ID="RegEx_TB_SO_No" runat="server" ValidationGroup="ModuleLicence"
                    ...
                    <tr style="vertical-align: top">
                        <td style="width: 400px; padding: 0px 10px 20px 0px">
                            ...
                            <asp:RegularExpressionValidator ID="RegEx_TB_Invoice_No" runat="server" ValidationGroup="ModuleLicence"
