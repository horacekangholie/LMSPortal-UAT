<%@ Page Title="LMSPortal - New Licence By PO" 
    Language="VB" 
    MasterPageFile="~/MasterPages/Frontend.master" 
    AutoEventWireup="false" 
    CodeFile="New_Licence_By_PO.aspx.vb" 
    Inherits="Reports_New_Licence_By_PO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" Runat="Server">
    ...
    <div class="form-group form-inline">
        <asp:LinkButton ID="BT_Download_Excel" runat="server" CssClass="btn btn-default" Text="Download excel" OnClientClick="document.forms[0].target='_blank';" Visible="true"></asp:LinkButton>
